			...
			if($.fn.circleProgress) {
			  progress1.appear(function () {
				progress1.circleProgress({
					...
					$(this).find('.h2').html(Math.round(20 * progress) + '<span></span>');
				  });
			  });
			};
		};
			...
			if($.fn.circleProgress) {
			  progress2.appear(function () {
				progress2.circleProgress({
					...
					$(this).find('.h2').html(Math.round(1500 * progress) + '<span></span>');
				  });
			  });
			};
		};
			...
			if($.fn.circleProgress) {
			  progress3.appear(function () {
				progress3.circleProgress({
					...
					$(this).find('.h2').html(Math.round(10 * progress) + '<span></span>');
				  });
			  });
			};
		};
